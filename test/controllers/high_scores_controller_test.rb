...
class HighScoresControllerTest < ActionController::TestCase
  ...
  test "should create high_score" do
    assert_difference('HighScore.count') do
      post :create, high_score: { idea_id: @high_score.idea_id, user_id: @high_score.user_id, vote: @high_score.vote }
    end
  ...
  test "should update high_score" do
    patch :update, id: @high_score, high_score: { idea_id: @high_score.idea_id, user_id: @high_score.user_id, vote: @high_score.vote }
    assert_redirected_to high_score_path(assigns(:high_score))
  end
